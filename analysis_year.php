...
$test=array();
$count=0;
$res=mysqli_query($link,"SELECT YEAR(crime_date) AS year, COUNT(crime_id) AS num_crimes FROM crime GROUP BY YEAR(crime_date);
");
while($row=mysqli_fetch_array($res))
{
    $test[$count]["label"]=$row["year"];
...
var chart = new CanvasJS.Chart("chartContainer", {
    ...
    theme: "light2",
    title:{
        text: "Crime History analysis (for years):"
    },
    axisY: {
...
<div class="container">
    <div class="content">
      <a href="analysis_location.php" class="btn">Next</a>
    </div>
</div>
</body>
</html>