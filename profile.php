...
<div class="pricing-wrapper clearfix">
        <h1 class="pricing-table-title">  PROFILE </h1>
    	...
    	<?php
            ...
            $select = " SELECT * , (YEAR(CURDATE()) - YEAR(dob)) as age FROM person WHERE aadhar_id = (SELECT officer_aadhar FROM officer WHERE officer_id = '$id') ; ";
		...
		<div class="pricing-table recommended">
			...
			<ul class="table-list">
				...
				<li><?php echo $_SESSION['officer_id'];?></li>
